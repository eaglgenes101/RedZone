 ...
 * away from the player. Every time a block next to them changes, they will be
 * alerted of the change, and if the block at their bottom face is not solid,
 * will drop an item corresponding to themselves.
 * <p>
 * Each wire type glows whenever supplied with a signal. This glow effect is
 * entirely aesthetic, and all active forms of wires are technical blocks, and
 * are not obtainable.
 * <p>
 * Components not considered wires may extend the Wire class. Press switches are
 * one such component.
 * 
 * @author eaglgenes101
 * @see StraightWire
	...
	public void doPlaceBlock(int focusbid, Player p, World w, int dimension, int x, int y, int z, int side)
	{
		...
		switch (side)
		{
			case 0:
				...
				{
					if (dx > 0)
						meta = Orienter.metadataTable[Orienter.UP][Orienter.WEST];
					else
						meta = Orienter.metadataTable[Orienter.UP][Orienter.EAST];
				}
				else
				{
					if (dz > 0)
						meta = Orienter.metadataTable[Orienter.UP][Orienter.NORTH];
					else
						meta = Orienter.metadataTable[Orienter.UP][Orienter.SOUTH];
				}
			...
			case 1:
				...
				{
					if (dx > 0)
						meta = Orienter.metadataTable[Orienter.NORTH][Orienter.WEST];
					else
						meta = Orienter.metadataTable[Orienter.NORTH][Orienter.EAST];
				}
				else
				{
					if (dy > 0)
						meta = Orienter.metadataTable[Orienter.NORTH][Orienter.UP];
					else
						meta = Orienter.metadataTable[Orienter.NORTH][Orienter.DOWN];
				}
			...
			case 2:
				...
				{
					if (dx > 0)
						meta = Orienter.metadataTable[Orienter.SOUTH][Orienter.WEST];
					else
						meta = Orienter.metadataTable[Orienter.SOUTH][Orienter.EAST];
				}
				else
				{
					if (dy > 0)
						meta = Orienter.metadataTable[Orienter.SOUTH][Orienter.UP];
					else
						meta = Orienter.metadataTable[Orienter.SOUTH][Orienter.DOWN];
				}
				w.setblockandmeta(dimension, x, y, z - 1, this.blockID, meta);
				break;
			case 3:
				...
				{
					if (dy > 0)
						meta = Orienter.metadataTable[Orienter.WEST][Orienter.UP];
					else
						meta = Orienter.metadataTable[Orienter.WEST][Orienter.DOWN];
				}
				else
				{
					if (dz > 0)
						meta = Orienter.metadataTable[Orienter.WEST][Orienter.NORTH];
					else
						meta = Orienter.metadataTable[Orienter.WEST][Orienter.SOUTH];
				}
			...
			case 4:
				...
				{
					if (dy > 0)
						meta = Orienter.metadataTable[Orienter.EAST][Orienter.UP];
					else
						meta = Orienter.metadataTable[Orienter.EAST][Orienter.DOWN];
				}
				else
				{
					if (dz > 0)
						meta = Orienter.metadataTable[Orienter.EAST][Orienter.NORTH];
					else
						meta = Orienter.metadataTable[Orienter.EAST][Orienter.SOUTH];
				}
				w.setblockandmeta(dimension, x + 1, y, z, this.blockID, meta);
				break;
			case 5:
				...
				{
					if (dx > 0)
						meta = Orienter.metadataTable[Orienter.DOWN][Orienter.WEST];
					else
						meta = Orienter.metadataTable[Orienter.DOWN][Orienter.EAST];
				}
				else
				{
					if (dz > 0)
						meta = Orienter.metadataTable[Orienter.DOWN][Orienter.NORTH];
					else
						meta = Orienter.metadataTable[Orienter.DOWN][Orienter.SOUTH];
				}
				w.setblockandmeta(dimension, x, y - 1, z, this.blockID, meta);
				break;
		}
