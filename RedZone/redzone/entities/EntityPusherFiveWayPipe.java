...
import redzone.blocks.PusherFiveWayPipe;
...
public class EntityPusherFiveWayPipe extends EntityFiveWayPipe
{
	...
	public EntityPusherFiveWayPipe(World w)
	{
		super(w);
		uniquename = "RedZone:EntityPusherFiveWayPipe";
		setVarInt(21, 0);
	}
	...
	public void update(float deltaT)
	{
		...
		if (myBlockID != RedZoneBlocks.PUSHER_FIVE_WAY_PIPE.blockID)
		{
			this.deadflag = true;
			return;
		}
		
		else if ( ((PusherFiveWayPipe) myBlock).getStatus(world, dimension, (int) posx, (int) posy, (int) posz))
		{
